...
namespace VCT.Client.Modules
{
	public class ScreenshotMaker
	{
		...
		public void MakeFullPageScreenshot(string outputFile)
		{
			MakeFullPageScreenshot(new FileInfo(outputFile));
		}

		public void MakeFullPageScreenshot(FileInfo outputFile)
		{
